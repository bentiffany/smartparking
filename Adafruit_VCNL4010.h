...
// include any I2C headers required
...
/** custom struct to replace an object that's truly unnecessary for my needs **/
typedef struct {
    bool detected_address;
    unsigned char addr;
} Adafruit_I2CDevice;
...
bool Adafruit_VCNL4010_begin(void);
bool Adafruit_VCNL4010_detectAddress(Adafruit_I2CDevice *);

uint8_t Adafruit_VCNL4010_getLEDcurrent(void);
void Adafruit_VCNL4010_setLEDcurrent(uint8_t c);

void Adafruit_VCNL4010_setFrequency(vcnl4010_freq f);
